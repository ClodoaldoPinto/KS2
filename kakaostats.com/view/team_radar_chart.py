...
@app.route("/team-radar-chart")
def team_radar_chart():
    ...
    yLabels = list()
    for i in range(0, 10):
        yLabels.append(locale.format('%.0f', (lowY + ((bigY - lowY) * i / 9.0)) / 1000, True))
    ...
    c.yAxis().setTitle("Thousand Points", "normal", 10);
